// Queries the table for attributes related to the GPS that 
// are associated with a particular driveid
...
int main(int argc, char* argv[]) {
    ...
    // And specify the attributes we care about
    ...
    std::cerr << "Lat: " << first_item.at("GPS_Lat").GetN() << ", ";
    std::cerr << "Lon: " << first_item.at("GPS_Lon").GetN() << ", ";
    std::cerr << "Alt: " << first_item.at("GPS_Alt").GetN() << std::endl;
